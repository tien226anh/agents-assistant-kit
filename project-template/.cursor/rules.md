...
<!-- This file provides rules for Cursor's AI agent. -->
...
Check the `.agents/skills/` directory for specialized skills that provide detailed instructions for specific tasks (code review, debugging, testing, git workflow, refactoring, skill orchestration).
